...
function PostDiscussion({ lang, postId }: PostDiscussionProps) {
  ...
  const sectionTitle = lang === 'ar' ? '\u0627\u0644\u062a\u0639\u0644\u064a\u0642\u0627\u062a \u0648\u0627\u0644\u062a\u0641\u0627\u0639\u0644\u0627\u062a' : 'Comments & Reactions';
  const sectionNote = lang === 'ar'
  ...
  return (
    <section className="post-discussion-shell" aria-labelledby={headingId}>
      <div className="post-discussion-header" dir={lang === 'ar' ? 'rtl' : 'ltr'}>
        <h2 className="post-discussion-title" id={headingId}>{sectionTitle}</h2>
        <p className="post-discussion-note">{sectionNote}</p>
      </div>
      <div className="giscus post-discussion-embed" data-post-id={postId} ref={containerRef} />
    </section>
  );
}
