...
import { AnalogueGridClock } from "../components/AnalogueGridClock";

const GOOGLE_LOGO_COLORS = ["#4285F4", "#EA4335", "#FBBC05", "#34A853"] as const;
    ...
    <div className="profile-block glass-panel home-enter home-enter-1">
      ...
      <div className="profile-info">
        ...
        <m3e-button-group
          ...
          variant="standard"
        >
          <m3e-icon-button href="https://www.instagram.com/adeissawe/" target="_blank" rel="noopener noreferrer" role="link" className="developer-link developer-link-instagram" aria-label="Instagram" size="small" variant="tonal">
          ...
          <m3e-icon-button href="https://github.com/7Wdev" target="_blank" rel="noopener noreferrer" role="link" className="developer-link developer-link-github" aria-label="GitHub" size="small" variant="tonal">
          ...
          <m3e-icon-button href="https://www.youtube.com/@AdeTheCoder" target="_blank" rel="noopener noreferrer" role="link" className="developer-link developer-link-youtube" aria-label="YouTube" size="small" variant="tonal">
            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
