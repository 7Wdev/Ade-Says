...
ختاما حبيت الخدعة تطلع من نطاق الكلام وتدخل حيز التطبيق. أخذت صورة شارع عادية من معرضي: ناس ماشية، برج ساعة، شاحنة صفراء، ولا أي إشي بثير الشك. بعدين عملت صورة أبيض وأسود مكتوب فيها <span class="inline-secret">SECRET</span>. هاي هي الصورة اللي خبيتها:

![صورة أبيض وأسود مكتوب فيها SECRET قبل إخفائها](./assets/hidden-source.png)

الخطوة اللي بعدها كانت إني أخلي هاي الصورة الواضحة تختفي جوّا صورة الشارع. مش ألصقها فوقها، بل أزرعها داخل أصغر قرارات اللون بالصورة.

الفكرة هبل لدرجة إنها بتحسها خدعة سحرية. كل بكسل في الصورة السرية بصير قرار واحد: آخر bit بقناة اللون يكون `0` أو `1`. اللون المرئي بتغير بدرجة واحدة بس من أصل 255، فالعين بتضل شايفة نفس الشارع. بس البكسلات، بهدوء تام، صارت شايلة رسالة تحت السطح.

هاد جزء الكود الي استخدمته عشان أخبي الصورة جوّا الصورة:
...
الصورة على اليمين هي <span class="inline-cover-hex">الغلاف</span>. الصورة على اليسار هي <span class="inline-carrier">الصورة الحاملة</span> بعد ما صورة SECRET اختفت داخل أهدى bits. نفس المنظر تقريباً، بس الثانية حاملة السر.
...
الصورة الحاملة اللي فوق مش مجرد لقطة توضيحية للمقال. هي فعلاً بقلبها الصورة المخفية. اعتقد رح يكون تحدّي ممتع إنك تكتب سكربت عكسي: اقرأ كل بكسل، خذ أول bit من قناة لون واحدة باستعمال `pixel.r & 1`، وارسم صورة جديدة: أبيض إذا كان الـ bit يساوي `1`، وأسود إذا كان `0`، وهيك بتعكس بالضبط التقنية اللي شرحناها. إذا عملتها صح، الكلمة لازم تبيّن معك.
